    ...
    public static List<ProcessLogMockDto> GetMockRecords()
    {
        return new List<ProcessLogMockDto>
        {
            ...
            new()
            {
                ...
                ClinchingHeightAverage = 12.49,
                EndPlateWidthResults = Enumerable.Repeat(true, 60).ToArray(),
                ...
                RadCoreAsmNameLabelResult = true,
                MotorFanAssyLabelResult = true,
                EcmAssyBoltTightenValue = 45.67,
                EcmAssyBoltTightenQtyValue = 4,
                NgBoxSensorEcmAssyValue = "ON",
                FinalInspectionRadCoreAsmNameLabelResult = true,
            ...
            new()
            {
                ...
                ClinchingHeightAverage = 12.51,
                EndPlateWidthResults = Enumerable.Range(0, 60).Select(i => i != 2 && i != 14).ToArray(),
